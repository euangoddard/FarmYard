(function (angular, _) {
    "use strict";
angular.module("menagerie.constants", []).constant("ANIMALS", ["cat","chicken","cockerel","cow","dog","donkey","elephant","fox","swipe","tap","horse","leopard","lion","lioness","monkey","orangutan","owl","panda","penguin","pig","puma","reindeer","sheep","tiger","zebra"]);
...
app.config(["$compileProvider", "SoundManagerProvider", "ImagePreloaderProvider", function ($compileProvider, SoundManagerProvider, ImagePreloaderProvider) {
...
app.controller('MenagerieCtrl', ["$scope", "$q", "SoundManager", "ImagePreloader", "HelpQueue", function ($scope, $q, SoundManager, ImagePreloader, HelpQueue) {
...
app.directive('animal', function () {
    return {
        ...
        controller: ["$scope", "vibration", "SoundManager", "HelpQueue", function ($scope, vibration, SoundManager, HelpQueue) {
            var timeout_promise;
...
app.factory('HelpQueue', ["$timeout", "$rootScope", function ($timeout, $rootScope) {
    var queue = [];
